    ...
    >
      <div
        className={`h-10 border-b flex items-center px-4 justify-between transition-colors duration-500 ${
          isDark ? "bg-white/[0.02] border-white/5" : "bg-zinc-50 border-black/5"
        }`}
      >
        <div
        ...
        >
          ...
          {phase === 2 && (
            <div className="animate-[fadeIn_0.5s_ease-out]">
              ...
              &nbsp;&nbsp;DATE_TRUNC(<span className="text-zinc-400">&apos;month&apos;</span>, date){" "}
    ...
    >
      <div
        className={`h-12 border-b flex items-center px-4 justify-between transition-colors duration-500 ${
          isDark ? "bg-white/[0.03] border-white/10" : "bg-zinc-50 border-black/10"
        }`}
      >
  ...
  return (
    ...
    >
      ...
      <div className="p-4 md:p-6 text-zinc-300 flex-1 overflow-x-auto whitespace-pre">
        ...
        <span className="text-green-300">&apos;@qbuilder/react&apos;</span>;<br />
        <br />
      ...
      <div className="min-h-screen relative font-sans selection:bg-blue-500/30">
        ...
        >
          ...
          >
            ...
            <button className={`lg:hidden ${isDark ? "text-white" : "text-zinc-900"}`}>
              <Menu />
            </button>
          </nav>
        </div>
        ...
        >
          ...
          <Reveal delay="delay-200" className="w-full">
            <div
              ...
              style={{ transform: "rotateX(var(--tilt-x, 0)) rotateY(var(--tilt-y, 0))" }}
            >
              <div
        ...
        <div
          className={`relative py-12 border-y overflow-hidden z-10 transition-colors duration-500 ${
            isDark ? "bg-white/[0.01] border-white/5" : "bg-black/[0.02] border-black/5"
          }`}
        >
          <div
        ...
        >
          ...
          <Reveal delay="delay-400" className="w-full max-w-[1200px] px-4 mx-auto relative z-20">
            <DesignerUI />
          </Reveal>
        </section>
